...
if (!is_array($strings)) {
    if (!file_exists('strings_it.json')) {
        ...
        file_put_contents('strings_it.json', file_get_contents('https://secure-tguserbot.alsogamer.tk/it/strings_it.json'));
    }
...
$menu->setTitle('Secure-TGUserBot Account Manager')
